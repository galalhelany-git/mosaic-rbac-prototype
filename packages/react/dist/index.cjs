...
function ChevronIcon({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("svg", { ...props, "aria-hidden": "true", fill: "none", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx(
    "path",
    {
      d: "m6 9 6 6 6-6",
      stroke: "currentColor",
...
function CloseIcon(props) {
  return /* @__PURE__ */ jsxRuntime.jsx("svg", { ...props, "aria-hidden": "true", fill: "none", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "m6 6 12 12M18 6 6 18", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "2" }) });
}
...
function MoreIcon(props) {
  return /* @__PURE__ */ jsxRuntime.jsxs("svg", { ...props, "aria-hidden": "true", fill: "currentColor", viewBox: "0 0 24 24", children: [
...
var Accordion = react.forwardRef(function Accordion2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ...props, className: clsx14__default.default("mosaic-accordion", className), ref, children: [
    /* @__PURE__ */ jsxRuntime.jsx(Heading, { className: "mosaic-accordion__heading", children: /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { className: "mosaic-accordion__icon", direction: isOpen ? "up" : "down" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-accordion__panel", hidden: !isOpen, id: panelId, children })
  ] });
});
...
var Avatar = react.forwardRef(function Avatar2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "span",
    {
      ...
      role: "img",
      children: [
        src ? /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", className: "mosaic-avatar__image", src }) : /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-avatar__initials", children: content }),
        status ? /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            "aria-hidden": "true",
            className: clsx14__default.default("mosaic-avatar__status", `mosaic-avatar__status--${status}`)
          }
        ) : null,
        roleBadge ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-avatar__role", children: roleBadge }) : null
      ]
    }
  );
});
var Badge = react.forwardRef(function Badge2({ children, className, rounded = true, variant = "default", ...props }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: loading ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs("span", { "aria-hidden": "true", className: "mosaic-button__loading", children: [
          /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: loadingDot }),
          /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: loadingRing }),
          /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: loadingDot })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-visually-hidden", children })
      ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        leadingIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-button__icon", children: leadingIcon }) : null,
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-button__label", children }),
        trailingIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-button__icon", children: trailingIcon }) : null
      ] })
    }
  );
});
var ButtonGroup = react.forwardRef(function ButtonGroup2({ children, className, label, orientation = "horizontal", ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...props,
      "aria-label": label,
      className: clsx14__default.default("mosaic-button-group", `mosaic-button-group--${orientation}`, className),
      ref,
      role: "group",
      children: react.Children.map(children, (child) => {
        if (!react.isValidElement(child)) return child;
        return react.cloneElement(child, {
          className: clsx14__default.default(child.props.className, "mosaic-button-group__item")
        });
      })
    }
  );
});
var Breadcrumb = react.forwardRef(function Breadcrumb2({ className, items, label = "Breadcrumb", maxItems = 5, moreLabel = "More pages", ...props }, ref) {
  const collapse = items.length > maxItems;
  const visible = collapse ? [items[0], null, ...items.slice(-(maxItems - 2))] : items;
  return /* @__PURE__ */ jsxRuntime.jsx("nav", { ...props, "aria-label": label, className: clsx14__default.default("mosaic-breadcrumb", className), ref, children: /* @__PURE__ */ jsxRuntime.jsx("ol", { className: "mosaic-breadcrumb__list", children: visible.map((item, index) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "li",
      {
        ...
        children: [
          index > 0 ? /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { className: "mosaic-breadcrumb__separator", direction: "right" }) : null,
          item ? current || !item.href ? /* @__PURE__ */ jsxRuntime.jsx(
            "span",
            {
              "aria-current": current ? "page" : void 0,
              className: clsx14__default.default(current && "mosaic-breadcrumb__current"),
              children: item.label
            }
          ) : /* @__PURE__ */ jsxRuntime.jsx("a", { href: item.href, onClick: item.onClick, children: item.label }) : /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-label": moreLabel, className: "mosaic-breadcrumb__ellipsis", role: "img", children: /* @__PURE__ */ jsxRuntime.jsx(MoreIcon, {}) })
        ]
      },
...
var Calendar = react.forwardRef(function Calendar2({
  ...
  const [focusDate, setFocusDate] = react.useState(() => startOfDay(initial ?? /* @__PURE__ */ new Date()));
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ...
    {
      ...props,
      className: clsx14__default.default("mosaic-calendar", presets?.length && "mosaic-calendar--presets", className),
      ref,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-calendar__main", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-calendar__header", children: [
            /* @__PURE__ */ jsxRuntime.jsx("button", { "aria-label": previousMonthLabel, onClick: () => changeMonth(-1), type: "button", children: /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { direction: "left" }) }),
            /* @__PURE__ */ jsxRuntime.jsx("strong", { "aria-live": "polite", id: `${calendarId}-month`, children: new Intl.DateTimeFormat(locale, { month: "long", year: "numeric" }).format(
              visibleMonth
            ) }),
            /* @__PURE__ */ jsxRuntime.jsx("button", { "aria-label": nextMonthLabel, onClick: () => changeMonth(1), type: "button", children: /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { direction: "right" }) })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { "aria-hidden": "true", className: "mosaic-calendar__weekdays", children: weekdays.map((day, index) => /* @__PURE__ */ jsxRuntime.jsx("span", { children: day }, `${day}-${index}`)) }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { "aria-labelledby": `${calendarId}-month`, className: "mosaic-calendar__grid", role: "grid", children: Array.from({ length: 6 }, (_, week) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-calendar__week", role: "row", children: days.slice(week * 7, week * 7 + 7).map((date) => {
        ...
        presets?.length ? /* @__PURE__ */ jsxRuntime.jsx("div", { "aria-label": presetsLabel, className: "mosaic-calendar__presets", role: "group", children: presets.map((preset) => /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => onChange?.(preset.value), type: "button", children: preset.label }, preset.label)) }) : null
      ]
    }
  );
});
...
var Checkbox = react.forwardRef(function Checkbox2({ className, disabled = false, id, indeterminate = false, label, ...props }, forwardedRef) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "label",
    {
      className: clsx14__default.default("mosaic-choice", disabled && "mosaic-choice--disabled", className),
      htmlFor: inputId,
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", className: "mosaic-choice__check", src: checkbox_check_default }),
              /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", className: "mosaic-choice__minus", src: checkbox_minus_default })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-choice__label", children: label })
      ]
    }
  );
});
var CloseButton = react.forwardRef(function CloseButton2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      className: clsx14__default.default("mosaic-close-button", `mosaic-close-button--${size}`, className),
      ref,
      type,
      children: /* @__PURE__ */ jsxRuntime.jsx("svg", { "aria-hidden": "true", fill: "none", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx(
        "path",
        {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: label ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-divider__line" }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-divider__label", children: label }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-divider__line" })
      ] }) : null
    }
  );
...
var IconButton = react.forwardRef(function IconButton2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      "aria-busy": loading || void 0,
      "aria-label": ariaLabel,
      className: clsx14__default.default("mosaic-icon-button", `mosaic-icon-button--${size}`, className),
      "data-loading": loading || void 0,
      disabled: disabled || loading,
      ref,
      type,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-icon-button__icon", children: loading ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-icon-button__spinner" }) : icon }),
        notification !== void 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-icon-button__notification", children: notification }) : null
      ]
    }
  );
});
var DashboardToggle = react.forwardRef(
  function DashboardToggle2({ className, defaultValue, label = "Dashboard view", onValueChange, options, value, ...props }, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...props,
        "aria-label": label,
        className: clsx14__default.default("mosaic-dashboard-toggle", className),
        ref,
        role: "radiogroup",
        children: options.map((option) => /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            type: "button",
            children: [
              option.icon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-dashboard-toggle__icon", children: option.icon }) : null,
...
var DatePicker = react.forwardRef(function DatePicker2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ...
    {
      ...props,
      className: clsx14__default.default("mosaic-date-picker", className),
      onKeyDown,
      ref,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            type: "button",
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: clsx14__default.default(!selected && "mosaic-date-picker__placeholder"), children: displayValue }),
...
var DialogHeader = react.forwardRef(function DialogHeader2({ align = "start", className, description, padding = 24, size = "lg", title, titleId, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...props,
      ...
      style: { padding },
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-dialog__title", id: titleId, children: title }),
        description ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-dialog__description", children: description }) : null
      ]
    }
  );
});
var DialogFooter = react.forwardRef(function DialogFooter2({ align = "end", children, className, fullWidth = false, padding = 24, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...props,
...
var Dialog = react.forwardRef(function Dialog2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "dialog",
    {
      ...
      className: clsx14__default.default("mosaic-dialog", `mosaic-dialog--${size}`, className),
      onCancel: (event) => {
        onCancel?.(event);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(DialogHeader, { description, padding: 24, title, titleId }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-dialog__body", children }),
        footer ? /* @__PURE__ */ jsxRuntime.jsx(DialogFooter, { children: footer }) : null
      ]
    }
  );
});
function Progress({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: clsx14__default.default("mosaic-progress", `mosaic-progress--${size}`, className),
      role: "progressbar",
      children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-progress__value", style: { inlineSize: `${percentage}%` } })
    }
  );
}
var FileUploader = react.forwardRef(function FileUploader2({
  accept,
  className,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx14__default.default("mosaic-file-uploader-wrap", className), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        ...props,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-file-uploader__icon", children: /* @__PURE__ */ jsxRuntime.jsx(UploadIcon, {}) }),
          /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "mosaic-file-uploader__content", children: [
            /* @__PURE__ */ jsxRuntime.jsx("strong", { children: label }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: uploading ? "Uploading\u2026" : description })
          ] })
        ]
      }
    ),
    uploading ? /* @__PURE__ */ jsxRuntime.jsx(Progress, { "aria-label": "Upload progress", value: progress }) : null
  ] });
});
...
var Input = react.forwardRef(function Input2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__label-row", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "mosaic-field__label", htmlFor: inputId, children: label }),
          counter && maxLength ? /* @__PURE__ */ jsxRuntime.jsxs("span", { "aria-live": "polite", className: "mosaic-field__counter", children: [
            getTextLength(value, defaultValue),
            "/",
            maxLength
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__control-column", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__control-row", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-input__field", children: [
              leadingIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-field__icon", children: leadingIcon }) : null,
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  ...props,
              ...
              trailingIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-field__icon", children: trailingIcon }) : null
            ] }),
            action ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-field__action", children: action }) : null
          ] }),
          helpText ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-field__help", id: helpId, children: helpText }) : null,
          errorMessage ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-field__error", id: errorId, role: "alert", children: errorMessage }) : null
        ] })
      ]
    }
  );
...
var Pagination = react.forwardRef(function Pagination2({
  className,
  currentPage,
  label = "Pagination",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("nav", { ...props, "aria-label": label, className: clsx14__default.default("mosaic-pagination", className), ref, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
    ...
    getPages(safeCurrent, safeTotal, siblingCount).map(
      (page) => typeof page === "number" ? /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
        ...
        page
      ) : /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-pagination__ellipsis", children: /* @__PURE__ */ jsxRuntime.jsx(MoreIcon, {}) }, page)
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
...
var Radio = react.forwardRef(function Radio2({ className, disabled = false, id, label, ...props }, ref) {
  const generatedId = react.useId();
  const inputId = id ?? `mosaic-radio-${generatedId}`;
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "label",
    {
      className: clsx14__default.default("mosaic-radio", disabled && "mosaic-radio--disabled", className),
      htmlFor: inputId,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-radio__mark" }),
...
var SearchField = react.forwardRef(function SearchField2({ className, disabled = false, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      className: clsx14__default.default(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-search-field__icon", children: /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: search_default }) })
      ]
    }
  );
});
...
var RoleBadge = react.forwardRef(function RoleBadge2({ className, role, size = 32, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "span",
    {
      ...props,
      "aria-label": roleNames[role],
      className: clsx14__default.default("mosaic-role-badge", `mosaic-role-badge--${size}`, className),
      ref,
      role: "img",
      children: /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: (size === 16 ? smallRoleIcons : roleIcons)[role] })
    }
  );
});
var RoleBadgeCell = react.forwardRef(function RoleBadgeCell2({ className, role, showRoleName = true, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { ...props, className: clsx14__default.default("mosaic-role-badge-cell", className), ref, children: [
    /* @__PURE__ */ jsxRuntime.jsx(RoleBadge, { role, size: 16 }),
    showRoleName ? /* @__PURE__ */ jsxRuntime.jsx("span", { children: roleNames[role] }) : null
  ] });
});
...
var Select = react.forwardRef(function Select2({
  ...
  const describedBy = [ariaDescribedBy, helpId, errorId].filter(Boolean).join(" ") || void 0;
  const invalid = Boolean(errorMessage) || ariaInvalid === true || ariaInvalid === "true";
  const resolvedLeadingIcon = leadingIcon === void 0 ? /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", src: checkmark_default }) : leadingIcon === false ? null : leadingIcon;
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      className: clsx14__default.default(
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__label-row", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "mosaic-field__label", htmlFor: selectId, children: label }),
          counter ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-field__counter", children: counter }) : null
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__control-column", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-select__field", children: [
            resolvedLeadingIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-field__icon", children: resolvedLeadingIcon }) : null,
            /* @__PURE__ */ jsxRuntime.jsx(
              "select",
              {
                ...props,
            ...
            /* @__PURE__ */ jsxRuntime.jsx("img", { "aria-hidden": "true", className: "mosaic-select__chevrons", src: chevrons_up_down_default })
          ] }),
          helpText ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-field__help", id: helpId, children: helpText }) : null,
          errorMessage ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-field__error", id: errorId, role: "alert", children: errorMessage }) : null
        ] })
...
var StatusBadge = react.forwardRef(function StatusBadge2({ children, className, status, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "span",
    {
      ...props,
      className: clsx14__default.default("mosaic-status-badge", `mosaic-status-badge--${status}`, className),
      ref,
      children: children ?? labels[status]
    }
  );
});
var Switch = react.forwardRef(function Switch2({ className, disabled = false, id, indeterminate = false, label, size = "md", ...props }, forwardedRef) {
  const generatedId = react.useId();
  const inputRef = react.useRef(null);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            ...
            "data-indeterminate": indeterminate || void 0,
            children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-switch__thumb" })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: label })
      ]
...
var SidebarItem = react.forwardRef(
  function SidebarItem2({ active = false, badge, className, collapsed = false, icon, label, trailingIcon, ...props }, ref) {
    const content = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "mosaic-sidebar-item__main", children: [
        icon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-sidebar-item__icon", children: icon }) : null,
        !collapsed ? /* @__PURE__ */ jsxRuntime.jsx("span", { children: label }) : null
      ] }),
      !collapsed && (badge || trailingIcon) ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "mosaic-sidebar-item__end", children: [
        badge,
        trailingIcon
      ] }) : null
    ] });
    const classes = clsx14__default.default(
      "mosaic-sidebar-item",
...
var Sidebar = react.forwardRef(function Sidebar2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "aside",
    {
      ...
      ref,
      children: [
        header ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-sidebar__header", children: header }) : null,
        /* @__PURE__ */ jsxRuntime.jsx("nav", { "aria-label": navigationLabel, className: "mosaic-sidebar__nav", children }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-sidebar__footer", children: [
          footer,
          onCollapsedChange ? /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                !collapsed ? /* @__PURE__ */ jsxRuntime.jsx("span", { children: collapseLabel }) : null
              ]
            }
          ) : null
        ] })
...
var Toast = react.forwardRef(function Toast2({
  actionLabel,
  className,
  description,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...props,
      "aria-atomic": "true",
      className: clsx14__default.default("mosaic-toast", error && "mosaic-toast--error", className),
      ref,
      role: error ? "alert" : "status",
      children: [
        leading ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "mosaic-snackbar__icon", children: leading }) : null,
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-toast__content", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-toast__title", children: title }),
          description ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-toast__description", children: description }) : null
        ] }),
        actionLabel ? /* @__PURE__ */ jsxRuntime.jsx("button", { className: "mosaic-toast__action", onClick: onAction, type: "button", children: actionLabel }) : null,
...
var Snackbar = react.forwardRef(function Snackbar2({ className, icon, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(Toast, { ...props, className: clsx14__default.default("mosaic-snackbar", className), leading: icon, ref });
});
var ToastViewport = react.forwardRef(function ToastViewport2({ children, className, expanded = true, label = "Notifications", ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...props,
...
var Tabs = react.forwardRef(function Tabs2({
  ...
  const [internalValue, setInternalValue] = react.useState(defaultValue ?? fallback);
  const selected = value ?? internalValue;
  const select = (id) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      ref,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { "aria-orientation": orientation, className: "mosaic-tabs__list", role: "tablist", children: tabs.map((tab, index) => /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
...
var Textarea = react.forwardRef(function Textarea2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-field__label-row", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "mosaic-field__label", htmlFor: textareaId, children: label }),
          counter && maxLength ? /* @__PURE__ */ jsxRuntime.jsxs("span", { "aria-live": "polite", className: "mosaic-field__counter", children: [
...
var TimePicker = react.forwardRef(function TimePicker2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ...props, className: clsx14__default.default("mosaic-time-picker", className), ref, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        type: "button",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: clsx14__default.default(!selected && "mosaic-time-picker__placeholder"), children: selected || placeholder }),
          /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { direction: open ? "up" : "down" })
        ]
      }
    ),
    open ? /* @__PURE__ */ jsxRuntime.jsx(
...
var Tooltip = react.forwardRef(function Tooltip2({ children, className, content, placement = "top", ...props }, ref) {
  const [open, setOpen] = react.useState(false);
  const id = react.useId();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ...
    {
      ...props,
      className: clsx14__default.default("mosaic-tooltip", `mosaic-tooltip--${placement}`, className),
      ref,
      children: [
        child,
        open ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mosaic-tooltip__content", id, role: "tooltip", children: content }) : null
      ]
    }
  );
});
var TopNavigation = react.forwardRef(function TopNavigation2({ account, actions, brand, className, navigation, navigationLabel = "Primary", ...props }, ref) {
  return /* @__PURE__ */ jsxRuntime.jsxs("header", { ...props, className: clsx14__default.default("mosaic-top-navigation", className), ref, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mosaic-top-navigation__brand", children: brand }),
    navigation ? /* @__PURE__ */ jsxRuntime.jsx("nav", { "aria-label": navigationLabel, className: "mosaic-top-navigation__nav", children: navigation }) : null,
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mosaic-top-navigation__actions", children: [
      actions,
      account
    ] })
  ] });
...
exports.DashboardToggle = DashboardToggle;
...
exports.RoleBadgeCell = RoleBadgeCell;
...
exports.mosaicReactPackage = mosaicReactPackage;
